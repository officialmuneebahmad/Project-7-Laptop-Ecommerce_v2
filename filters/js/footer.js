...
<!-- ======================== FOOTER =========================================-->
     ...
     <footer id="footer" class="flex flex-row justify-between items-start p-4 mt-8">
        ...
        <div class=" flex flex-col justify-center items-center">
            <img id="logo" class="size-32 rounded-3xl " src="../../imgs/logo.png" alt="logo">
            <p class=" w-64 p-2">
     ...
     <div id="web-end" class="flex justify-between items-center p-4 mt-8 bg-bgBlue text-white">
        ...
        <p class="flex justify-around items-center"> Made with ❤️ from <img id="pakflag" class="size-8 mx-4" src="../../imgs/flag.png" alt="pak-flag"></p>
     </div>
    `;
